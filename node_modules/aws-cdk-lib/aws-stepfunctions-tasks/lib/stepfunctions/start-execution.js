...
class StepFunctionsStartExecution extends sfn.TaskStateBase {
    constructor(scope, id, props) {
        ...
        (0, task_utils_1.validatePatternSupported)(this.integrationPattern, StepFunctionsStartExecution.SUPPORTED_INTEGRATION_PATTERNS);
    ...
    _renderTask() {
        ...
        return {
            Resource: `${(0, task_utils_1.integrationResourceArn)('states', 'startExecution', this.integrationPattern)}${suffix}`,
...
StepFunctionsStartExecution[_a] = { fqn: "aws-cdk-lib.aws_stepfunctions_tasks.StepFunctionsStartExecution", version: "2.74.0" };
