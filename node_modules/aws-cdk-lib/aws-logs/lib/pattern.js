...
JsonPattern[_a] = { fqn: "aws-cdk-lib.aws_logs.JsonPattern", version: "2.74.0" };
...
class FilterPattern {
    ...
    static all(...patterns) {
        try {
            jsiiDeprecationWarnings.aws_cdk_lib_aws_logs_JsonPattern(patterns);
        }
        catch (error) {
...
FilterPattern[_b] = { fqn: "aws-cdk-lib.aws_logs.FilterPattern", version: "2.74.0" };
...
SpaceDelimitedTextPattern[_c] = { fqn: "aws-cdk-lib.aws_logs.SpaceDelimitedTextPattern", version: "2.74.0" };
