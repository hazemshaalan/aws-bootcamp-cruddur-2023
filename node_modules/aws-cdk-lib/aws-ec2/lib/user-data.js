...
class UserData {
    ...
    static forWindows(options = {}) {
        try {
            jsiiDeprecationWarnings.aws_cdk_lib_aws_ec2_WindowsUserDataOptions(options);
        }
        catch (error) {
            if (process.env.JSII_DEBUG !== "1" && error.name === "DeprecationError") {
...
UserData[_a] = { fqn: "aws-cdk-lib.aws_ec2.UserData", version: "2.74.0" };
...
MultipartBody[_b] = { fqn: "aws-cdk-lib.aws_ec2.MultipartBody", version: "2.74.0" };
/**
...
class MultipartUserData extends UserData {
    ...
    addSignalOnExitCommand(resource) {
        try {
            ...
            if (process.env.JSII_DEBUG !== "1" && error.name === "DeprecationError") {
                Error.captureStackTrace(error, this.addSignalOnExitCommand);
            }
            throw error;
        }
        if (this.defaultUserData) {
...
MultipartUserData[_c] = { fqn: "aws-cdk-lib.aws_ec2.MultipartUserData", version: "2.74.0" };
