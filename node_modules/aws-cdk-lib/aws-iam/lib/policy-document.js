...
class PolicyDocument {
    ...
    constructor(props = {}) {
        ...
        try {
            jsiiDeprecationWarnings.aws_cdk_lib_aws_iam_PolicyDocumentProps(props);
        }
        catch (error) {
