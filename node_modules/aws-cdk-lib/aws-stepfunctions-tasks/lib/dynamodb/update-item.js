...
class DynamoUpdateItem extends sfn.TaskStateBase {
    ...
    _renderTask() {
        return {
            Resource: (0, utils_1.getDynamoResourceArn)(utils_1.DynamoMethod.UPDATE),
