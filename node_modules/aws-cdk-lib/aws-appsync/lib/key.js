...
KeyCondition[_a] = { fqn: "aws-cdk-lib.aws_appsync.KeyCondition", version: "2.77.0" };
...
Assign[_b] = { fqn: "aws-cdk-lib.aws_appsync.Assign", version: "2.77.0" };
...
PartitionKeyStep[_c] = { fqn: "aws-cdk-lib.aws_appsync.PartitionKeyStep", version: "2.77.0" };
...
SortKeyStep[_d] = { fqn: "aws-cdk-lib.aws_appsync.SortKeyStep", version: "2.77.0" };
...
PrimaryKey[_e] = { fqn: "aws-cdk-lib.aws_appsync.PrimaryKey", version: "2.77.0" };
...
PartitionKey[_f] = { fqn: "aws-cdk-lib.aws_appsync.PartitionKey", version: "2.77.0" };
...
AttributeValues[_g] = { fqn: "aws-cdk-lib.aws_appsync.AttributeValues", version: "2.77.0" };
...
AttributeValuesStep[_h] = { fqn: "aws-cdk-lib.aws_appsync.AttributeValuesStep", version: "2.77.0" };
...
Values[_j] = { fqn: "aws-cdk-lib.aws_appsync.Values", version: "2.77.0" };
