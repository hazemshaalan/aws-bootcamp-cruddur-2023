...
class CfnAccessPoint extends cdk.CfnResource {
    ...
    constructor(scope, id, props) {
        ...
        try {
            jsiiDeprecationWarnings.aws_cdk_lib_aws_efs_CfnAccessPointProps(props);
        }
        catch (error) {
...
CfnAccessPoint[_a] = { fqn: "aws-cdk-lib.aws_efs.CfnAccessPoint", version: "2.77.0" };
/**
...
class CfnFileSystem extends cdk.CfnResource {
    ...
    constructor(scope, id, props = {}) {
        ...
        try {
            jsiiDeprecationWarnings.aws_cdk_lib_aws_efs_CfnFileSystemProps(props);
        }
        catch (error) {
            if (process.env.JSII_DEBUG !== "1" && error.name === "DeprecationError") {
...
CfnFileSystem[_b] = { fqn: "aws-cdk-lib.aws_efs.CfnFileSystem", version: "2.77.0" };
/**
 * The CloudFormation resource type name for this resource class.
 */
...
class CfnMountTarget extends cdk.CfnResource {
    ...
    constructor(scope, id, props) {
        ...
        try {
            jsiiDeprecationWarnings.aws_cdk_lib_aws_efs_CfnMountTargetProps(props);
        }
        catch (error) {
            if (process.env.JSII_DEBUG !== "1" && error.name === "DeprecationError") {
